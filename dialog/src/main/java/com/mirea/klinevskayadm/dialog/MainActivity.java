    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPickDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                com.mirea.klinevskayadm.dialog.MyDateDialogFragment mDatePickerDialogFragment;
                mDatePickerDialogFragment = new com.mirea.klinevskayadm.dialog.MyDateDialogFragment();
